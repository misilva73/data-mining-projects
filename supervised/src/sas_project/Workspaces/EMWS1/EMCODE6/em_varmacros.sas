...
%let EM_NUM_VARS = 23;
   %macro EM_VARS;
    Custid DepVar F_DepVar I_DepVar Marital_Status MntCard_Games MntMagazines
   NumCatalogPurchases NumDealsPurchases NumWebPurchases P_DepVar0 P_DepVar1
   RANGE_Frq RANGE_Recency RANGE_average_purchase RANGE_campaign_acceptance
   R_DepVar0 R_DepVar1 U_DepVar _WARN_ _XVAL_ b_DepVar cv_var
   %mend EM_VARS;
%let EM_NUM_CLASS = 7;
   %macro EM_CLASS;
    DepVar F_DepVar I_DepVar Marital_Status U_DepVar _WARN_ b_DepVar
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 16;
   %macro EM_INTERVAL;
    Custid MntCard_Games MntMagazines NumCatalogPurchases NumDealsPurchases
   NumWebPurchases P_DepVar0 P_DepVar1 RANGE_Frq RANGE_Recency
   RANGE_average_purchase RANGE_campaign_acceptance R_DepVar0 R_DepVar1 _XVAL_
   cv_var
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 11;
   %macro EM_INPUT;
    Marital_Status MntCard_Games MntMagazines NumCatalogPurchases
   NumDealsPurchases NumWebPurchases RANGE_Frq RANGE_Recency
   RANGE_average_purchase RANGE_campaign_acceptance _XVAL_
   %mend EM_INPUT;
