...
%let EM_NUM_VARS = 20;
   ...
   R_DepVar0 R_DepVar1 U_DepVar _WARN_ cv_var
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
...
%let EM_NUM_INTERVAL = 14;
   %macro EM_INTERVAL;
    Custid MntCard_Games NumCatalogPurchases NumDealsPurchases NumWebPurchases
   P_DepVar0 P_DepVar1 RANGE_Frq RANGE_Recency RANGE_average_purchase
   RANGE_campaign_acceptance R_DepVar0 R_DepVar1 cv_var
   %mend EM_INTERVAL;
