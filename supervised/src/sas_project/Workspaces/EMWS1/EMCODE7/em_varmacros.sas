...
%let EM_NUM_VARS = 22;
   %macro EM_VARS;
    Custid DepVar EM_CLASSIFICATION EM_CLASSTARGET EM_EVENTPROBABILITY
   EM_PROBABILITY F_DepVar Marital_Status MntCard_Games MntMagazines
...
%let EM_NUM_CLASS = 7;
   %macro EM_CLASS;
    DepVar EM_CLASSIFICATION EM_CLASSTARGET F_DepVar Marital_Status U_DepVar
   _WARN_
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 15;
   %macro EM_INTERVAL;
    Custid EM_EVENTPROBABILITY EM_PROBABILITY MntCard_Games MntMagazines
   NumCatalogPurchases NumDealsPurchases NumWebPurchases RANGE_Frq RANGE_Recency
...
%let EM_NUM_CLASSIFICATION = 3;
   %macro EM_CLASSIFICATION;
    EM_CLASSIFICATION F_DepVar U_DepVar
