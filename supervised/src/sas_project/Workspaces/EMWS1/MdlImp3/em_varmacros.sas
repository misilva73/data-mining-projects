...
%let EM_NUM_VARS = 18;
   ...
   NumDealsPurchases P_DepVar0 P_DepVar1 Q_DepVar0 Q_DepVar1 RANGE_Recency
   RANGE_campaign_acceptance R_DepVar0 R_DepVar1 U_DepVar _WARN_ _XVAL_
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
...
%let EM_NUM_INTERVAL = 12;
   %macro EM_INTERVAL;
    MntCard_Games NumCatalogPurchases NumDealsPurchases P_DepVar0 P_DepVar1
