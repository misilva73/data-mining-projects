...
%let EM_NUM_VARS = 16;
   %macro EM_VARS;
    DepVar F_DepVar I_DepVar MntCard_Games NumCatalogPurchases P_DepVar0 P_DepVar1
   Q_DepVar0 Q_DepVar1 RANGE_Recency RANGE_campaign_acceptance R_DepVar0 R_DepVar1
   U_DepVar _WARN_ _XVAL_
   %mend EM_VARS;
%let EM_NUM_CLASS = 5;
   %macro EM_CLASS;
    DepVar F_DepVar I_DepVar U_DepVar _WARN_
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 11;
   %macro EM_INTERVAL;
    MntCard_Games NumCatalogPurchases P_DepVar0 P_DepVar1 Q_DepVar0 Q_DepVar1
   RANGE_Recency RANGE_campaign_acceptance R_DepVar0 R_DepVar1 _XVAL_
   %mend EM_INTERVAL;
