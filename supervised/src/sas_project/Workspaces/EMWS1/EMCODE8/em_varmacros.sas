...
%let EM_NUM_VARS = 22;
   ...
   R_DepVar0 R_DepVar1 U_DepVar _WARN_ _dataobs_ b_DepVar
   %mend EM_VARS;
%let EM_NUM_CLASS = 7;
   %macro EM_CLASS;
    DepVar F_DepVar I_DepVar Marital_Status U_DepVar _WARN_ b_DepVar
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 15;
   %macro EM_INTERVAL;
   ...
   RANGE_average_purchase RANGE_campaign_acceptance R_DepVar0 R_DepVar1 _dataobs_
   %mend EM_INTERVAL;
