...
*------------------------------------------------------------*;
proc freq data=EMWS1.Meta_TRAIN noprint;
format
DepVar BEST.
;
table
...
_Pformat1 = '0'
then do;
if (2103+1-_C000003)*_genvalue_ <= (1472 - _C000001) then do;
_C000001 + 1;
...
_Pformat1 = '1'
then do;
if (334+1-_C000006)*_genvalue_ <= (234 - _C000004) then do;
_C000004 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
