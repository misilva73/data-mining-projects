...
%let EM_NUM_VARS = 19;
   %macro EM_VARS;
    Custid DepVar F_DepVar I_DepVar MntCard_Games NumCatalogPurchases P_DepVar0
   P_DepVar1 Q_DepVar0 Q_DepVar1 RANGE_Recency RANGE_campaign_acceptance R_DepVar0
   R_DepVar1 U_DepVar _NODE_ _WARN_ _XVAL_ cv_var
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
    DepVar F_DepVar I_DepVar U_DepVar _NODE_ _WARN_
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 13;
   %macro EM_INTERVAL;
    Custid MntCard_Games NumCatalogPurchases P_DepVar0 P_DepVar1 Q_DepVar0
   Q_DepVar1 RANGE_Recency RANGE_campaign_acceptance R_DepVar0 R_DepVar1 _XVAL_
   cv_var
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 5;
   %macro EM_INPUT;
    MntCard_Games NumCatalogPurchases RANGE_Recency RANGE_campaign_acceptance
   _XVAL_
   %mend EM_INPUT;
...
%let EM_NUM_REJECTS = 6;
   %macro EM_REJECTS;
    Marital_Status MntMagazines NumDealsPurchases NumWebPurchases RANGE_Frq
