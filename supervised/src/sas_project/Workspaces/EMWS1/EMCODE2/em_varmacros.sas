...
%let EM_NUM_VARS = 28;
   ...
   Custid DepVar Dt_Customer Education IMP_Income IMP_MntBrandA__Material
   IMP_MntScenario Kidhome Marital_Status MntCard_Games MntMagazines MntMiniatures
   MntPainting_Material NumCatalogPurchases NumDealsPurchases NumStorePurchases
   NumWebPurchases NumWebVisitsMonth Recency Teenhome Year_Birth _WARN_
   %mend EM_VARS;
%let EM_NUM_CLASS = 10;
   %macro EM_CLASS;
    AcceptedCmp1 AcceptedCmp2 AcceptedCmp3 AcceptedCmp4 AcceptedCmp5 Complain
   DepVar Education Marital_Status _WARN_
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 18;
   %macro EM_INTERVAL;
    Custid Dt_Customer IMP_Income IMP_MntBrandA__Material IMP_MntScenario Kidhome
...
%let EM_NUM_INPUT = 25;
   %macro EM_INPUT;
    AcceptedCmp1 AcceptedCmp2 AcceptedCmp3 AcceptedCmp4 AcceptedCmp5 Complain
   Dt_Customer Education IMP_Income IMP_MntBrandA__Material IMP_MntScenario
   Kidhome Marital_Status MntCard_Games MntMagazines MntMiniatures
   MntPainting_Material NumCatalogPurchases NumDealsPurchases NumStorePurchases
   NumWebPurchases NumWebVisitsMonth Recency Teenhome Year_Birth
   %mend EM_INPUT;
...
%let EM_NUM_INTERVAL_INPUT = 17;
   %macro EM_INTERVAL_INPUT;
    Dt_Customer IMP_Income IMP_MntBrandA__Material IMP_MntScenario Kidhome
   MntCard_Games MntMagazines MntMiniatures MntPainting_Material
   NumCatalogPurchases NumDealsPurchases NumStorePurchases NumWebPurchases
   NumWebVisitsMonth Recency Teenhome Year_Birth
