...
%let EM_NUM_VARS = 18;
   %macro EM_VARS;
    DepVar F_DepVar I_DepVar Marital_Status MntCard_Games NumCatalogPurchases
   NumDealsPurchases NumWebPurchases P_DepVar0 P_DepVar1 RANGE_Frq RANGE_Recency
   RANGE_average_purchase RANGE_campaign_acceptance R_DepVar0 R_DepVar1 U_DepVar
   _WARN_
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
...
%let EM_NUM_INTERVAL = 12;
   %macro EM_INTERVAL;
    MntCard_Games NumCatalogPurchases NumDealsPurchases NumWebPurchases P_DepVar0
   P_DepVar1 RANGE_Frq RANGE_Recency RANGE_average_purchase
   RANGE_campaign_acceptance R_DepVar0 R_DepVar1
   %mend EM_INTERVAL;
...
%let EM_NUM_INTERVAL_INPUT = 8;
   %macro EM_INTERVAL_INPUT;
    MntCard_Games NumCatalogPurchases NumDealsPurchases NumWebPurchases RANGE_Frq
   RANGE_Recency RANGE_average_purchase RANGE_campaign_acceptance
